...
public class EnemyAIGobelinArcher : MonoBehaviour
{
    ...
    // Distance minimale pour déclencher une attaque à distance (l'ennemi s'arrête en dehors de cette portée)
    ...
    //Point d'apparition de départ de la flèche
    ...
    void FixedUpdate()
    {
        ...
        if (playerDistance > rangedAttackRange)
        {
    ...
    void ShootArrow()
    {
        ...
        Instantiate(arrow, arrowSpawnPoint.position,rotation);
    }
